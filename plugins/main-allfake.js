...
global.namechannel = '𝐷𝑈𝑂𝐿𝐼𝑁𝐺𝑂 𝐴𝐼'
global.namegrupo = '𝘿𝙪𝙤𝙡𝙞𝙣𝙜𝙤-𝙖𝙞'
global.namecomu = '𝘿𝙐𝙊𝙇𝙄𝙉𝙂𝙊-𝘼𝙄'
global.listo = '⚽️ ＡＱＵＩ ＴＩＥＮＥＳ ＭＥＮ'
global.fotoperfil = await conn.profilePictureUrl(m.sender, 'image').catch(_ => 'https://qu.ax/syoFL.jpg')

//Ids channel
global.idchannel = '120363312092804854@newsletter'
global.canalIdM = ["120363312092804854@newsletter"]
global.canalNombreM = ["𝘿𝙐𝙊𝙇𝙄𝙉𝙂𝙊-𝘼𝙄"]
...
global.icono = [ 
'https://qu.ax/cltYz.jpg',
].getRandom()

global.menum = [ 
'https://qu.ax/gAExo.jpg',
].getRandom()
