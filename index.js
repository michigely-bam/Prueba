// INDEX LO MAS IMPORTANTE SEGUN YO :V
// ESTE INDEX LO ROBE DE MI OTRO BOT Y ME VALE :》
...
_quickTest().then(() => conn.logger.info(chalk.bold(`YA ESTA ✨️\n`.trim()))).catch(console.error)
